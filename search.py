...
def depthFirstSearch(problem):
    ...
    while True:
        ...
        if problem.isGoalState(path[-1][0]):
            return [action[1] for action in path]
    ...
    while True:
        ...
        if path[-1][0] not in visited:
            ...
            for successor in problem.getSuccessors(path[-1][0]):
                newpath = path.copy()
                newpath.append(successor)
                fringe.push(newpath, problem.getCostOfActions([action[1] for action in newpath]))
    ...
    while True:
        ...
        if path[-1][0] not in visited:
            ...
            for successor in problem.getSuccessors(path[-1][0]):
                newpath = path.copy()
                newpath.append(successor)
                fringe.push(newpath, problem.getCostOfActions([action[1] for action in newpath]) + heuristic(successor[0], problem))
